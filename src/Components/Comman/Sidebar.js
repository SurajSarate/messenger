          ...
          <div className="d-flex flex-column h-100 position-relative ">
            <div className="hide-scrollbar">
              <div className="container py-8">
                ...
                <div className="card-list">
                  <Link to="/chat-group" className="card border-0 text-reset">
                    <div className="card-body">
                      <div className="row gx-5">
                        <div className="col-auto">
                          <div className="avatar avatar-online">
                    ...
                    <div className="card-footer">
                      <div className="row align-items-center gx-4">
                        ...
                        <div className="col">
                          <h6 className="mb-0">Demo Group</h6>
                        </div>
                  ...
                  <Link to="/chat-direct" className="card border-0 text-reset">
                    <div className="card-body">
                      <div className="row gx-5">
                        <div className="col-auto">
                          <div className="avatar avatar-online">
                  ...
                  <Link to="/chat-empty" className="card border-0 text-reset">
                    <div className="card-body">
                      <div className="row gx-5">
                        <div className="col-auto">
                          <div className="avatar avatar-online">
                    ...
                    <div className="card-body">
                      <div className="row gx-5">
                        ...
                        <div className="col">
                          ...
                          <div className="d-flex">
                            <div className="me-auto">
                              Your password has been <br /> updated
                              successfully.
                            </div>
