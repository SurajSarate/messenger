      ...
      <div className="offcanvas-header py-4 py-lg-7 border-bottom">
        ...
        <div className="dropdown">
          ...
          <ul className="dropdown-menu">
            <li>
              <a to="#" className="dropdown-item d-flex align-items-center">
                Edit
                ...
                <div className="row align-items-center gx-5">
                  <div className="col-auto">
                    <div className="avatar-group">
                      <a to="#" className="avatar avatar-sm">
                        <img
                          src="assets/img/avatars/2.jpg"
                          className="avatar-img"
                          alt="#"
                  ...
                  <div className="col overflow-hidden">
                    <h5 className="text-truncate">
                      <a to="#">E5419783-047D-4B4C-B30E-F24DD8247731.JPG</a>
                    </h5>
...
export default ProfileAboutSide;
