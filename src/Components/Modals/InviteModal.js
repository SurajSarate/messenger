          ...
          <div className="modal-body py-0">
            <div className="profile modal-gx-n">
              <div className="profile-img text-primary rounded-top-xl">
                ...
                >
                  <defs><style>{`.cls-2{fill:#fff;opacity:0.1;`}</style></defs>
                  <g>
                    <g>
            ...
            <div className="modal-py">
              <form className="row gy-6">
                <div className="col-12">
                  <label htmlFor="invite-email" className="form-label text-muted">
                    E-mail
                  </label>
                  <input
                    type="email"
                ...
                <div className="col-12">
                  <label htmlFor="invite-message" className="form-label text-muted">
                    Message
                  </label>
                  <textarea
                    className="form-control form-control-lg"
